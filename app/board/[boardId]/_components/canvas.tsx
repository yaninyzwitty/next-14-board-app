...
import {useCallback, useMemo, useState, useEffect, KeyboardEvent} from "react";
...
import {CursorsPresence} from "./cursors-prescence";
  ...
  return (
    <main className="h-full w-full relative bg-neutral-100 touch-none">
      ...
      <Toolbar
        ...
        redo={history.redo}
      />
      <SelectionTools camera={camera} setLastUseColor={setLastUseColor} />
